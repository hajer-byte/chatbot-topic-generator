...
import useUser from '../../../../../../../account/hooks/user';
import { getImageUrl } from 'lib/files';

import cpIcon from '../../../../../../assets/images/cp-logo-small.png';
import profileFallback from '../../../../../../../account/assets/images/profile-fallback.png';
...
const ChatItem = () => {
  ...
  const avatarUrl = avatar ? getImageUrl(avatar.filename_disk, org) : profileFallback;

  message.userPic = message.identifier === 'user' ? avatarUrl : cpIcon;
  message.userName = message.identifier === 'user' ? `${first_name} ${last_name}` : 'Contentpepper';
